...
class PuzzleGUI:
    ...
    def setup_ui(self):
        ...
        for val in range(1, 9):
            lbl = tk.Label(self.canvas_bg, text=str(val), font=("Segoe UI", 36, "bold"), 
        ...
        ttk.Label(target_frame, text="Đích").grid(row=0, column=0, columnspan=3, pady=(0, 5))
        self.target_entries = []
        for r in range(3):
            row_entries = []
            for c in range(3):
        ...
        try:
            ...
            for r in range(3):
                for c in range(3):
                    ...
                    target_vals.append(int(self.target_entries[r][c].get().strip()))
    ...
    def slide_tile(self, tile_widget, start_coords, end_coords, callback):
        ...
        def do_step(step):
            ...
            if step < steps:
                ...
                tile_widget.place(x=new_x, y=new_y)
